...
class ZipFile:
    ...
    def __init__(self, file, mode="r", compression=ZIP_STORED, allowZip64=False, fileencoding=ZIP_ENCODING):
    ...
    def _RealGetContents(self):
        ...
        while total < size_cd:
            ...
            filename = filename.decode(self.fileencoding)
    ...
    def open(self, name, mode="r", pwd=None):
        ...
        fname = zef_file.read(fheader[_FH_FILENAME_LENGTH]).decode(self.fileencoding)
